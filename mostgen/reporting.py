...
Validity отвечает только за машинно проверяемую химическую корректность и не равна устойчивости соединения. Uniqueness считается среди валидных канонических SMILES, Novelty — среди уникальных валидных структур относительно фактического training set, но не мировой химической литературы. Internal diversity — точное среднее расстояние Morgan/Tanimoto по всем парам уникальных валидных структур; scaffold diversity — доля generic Murcko scaffold. SA-score в этом прототипе — прозрачный complexity proxy, не оценка маршрута синтеза. Поэтому высокая novelty или низкий SA не означают коммерческую доступность продукта реакции.
